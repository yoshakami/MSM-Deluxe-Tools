...
create_list = []
a = Tk()
a.title('MSM Tools : arc extract and compress')
a.minsize(660, 440)
a.config(bg='#aacfff')
...
text_label = Label(a, text='Current working directory is', bg='#aacfff', width=30)
...
brawlcrate = Label(a, text='Brawlcrate is recommended\nto edit brres (especially in MSM)', bg='#aacfff', width=30)
...
lextract = Label(a, text='Extract                           Process can take up to 1 minute    ', font=500, bg='#aacfff', height=3)
lextract.grid(row=2, column=0, rowspan=2, columnspan=3)

extract_allbu = Button(a, text='Extract all files', command=extract_all, activebackground='#ff9999', width=20)
extract_allbu.grid(row=2, column=3)

expextract = Button(a, text='Open file explorer', command=explorer_extract, activebackground='#99ffee', width=20)
expextract.grid(row=3, column=3)

lcreate = Label(a, text='Create           ', font=500, bg='#aacfff')
lcreate.grid(row=16, column=0)

larchive = Label(a, text='  output file archive type  ->', bg='#aacfff')
larchive.grid(row=16, column=0, columnspan=2)

lcompression = Label(a, text='              compression  ->', bg='#aacfff')
...
expcreate = Button(a, text='Open file explorer', command=explorer_create, activebackground='#99ffee', width=20)
expcreate.grid(row=17, column=0, sticky='w')

lfiletypes = Label(a, text='default -> u8 = arc | u8 + yaz0 = szs | wu8 + bz = wbz', bg='#aacfff', width=54)
