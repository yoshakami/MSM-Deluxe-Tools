...
ltitle = Label(a, text="Mario Sports Mix Modding Website", font=300, bg="#bfffaa", height=3)
ltitle.grid(row=0, columnspan=3)
lhowto = Button(a, text="Getting Started", command=howto, activebackground="#ff7f7f", width=30)
lhowto.grid(row=3, column=0)
ltht = Button(a, text="Texture Hack Tutorial", command=tht, activebackground="#ffa555", width=30)
ltht.grid(row=3, column=1)
lbrsar = Button(a, text="Red_Star.brsar index", command=brsar, activebackground="#ffff7f", width=30)
lbrsar.grid(row=3, column=2)
l1 = Label(a, text="", bg="#bfffaa", width=35)
l1.grid(row=4, column=1)
llist_fr = Button(a, text="French ID-List", command=list_fr, activebackground="#dfff7f", width=30)
llist_fr.grid(row=5, column=0)
ltht_fr = Button(a, text="French Texture Hack Tutorial", command=tht_fr, activebackground="#bfff7f", width=30)
ltht_fr.grid(row=5, column=1)
llist_en = Button(a, text="English ID-List", command=list_en, activebackground="#7fff7f", width=30)
llist_en.grid(row=5, column=2)
l2 = Label(a, text="", bg="#bfffaa")
l2.grid(row=6)
linfo = Button(a, text="Characters Info", command=info, activebackground="#7fffbf", width=30)
linfo.grid(row=7, column=0)
lfilesystem = Button(a, text="Filesystem", command=filesystem, activebackground="#7fffff", width=30)
lfilesystem.grid(row=7, column=1)
lcustom = Button(a, text="Custom Character Tutorial", command=custom, activebackground="#7f7fff", width=30)
lcustom.grid(row=7, column=2)
l3 = Label(a, text="", bg="#bfffaa")
l3.grid(row=8, column=1)
lmods = Button(a, text="Showcased Mods", command=mods, activebackground="#bf7fff", width=30)
lmods.grid(row=9, column=0)
lmesg = Button(a, text="Msbt text index", command=mesg, activebackground="#ff7fff", width=30)
lmesg.grid(row=9, column=1)
ltcrf = Button(a, text="The Cutting Room Floor Webpage", command=tcrf, activebackground="#ff7fbf", width=30)
ltcrf.grid(row=9, column=2)
l4 = Label(a, text="", bg="#bfffaa")
l4.grid(row=10, column=1)
lsheet = Button(a, text="Google Sheet with all Custom Characters, Stages Texture Hacks, and pack 2 Character List", command=sheet, activebackground="#a9ff91", width=100, height=2)
lsheet.grid(row=11, rowspan=2, columnspan=20)
l5 = Label(a, text="", bg="#bfffaa")
l5.grid(row=13)
ldiscord = Button(a, text="Join our Discord", activebackground="#8888ff", command=discord, width=25)
ldiscord.grid(row=14, column=1)
lyt = Button(a, text="Yosh's YouTube Channel", activebackground="#ff7f7f", command=yt, width=25)
lyt.grid(row=15, column=1)
exitbu = Button(a, text="Exit", activebackground="#a9ff91", command=a.quit, width=25)
exitbu.grid(row=16, column=1)
msm1 = Canvas(a, width=216, height=148)
msm_msm = PhotoImage(file="C:\\Yosh\\msm.png")
msm1.create_image(110, 90, image=msm_msm)
msm1.grid(row=13, column=0, rowspan=6)
msm2 = Canvas(a, width=216, height=148)
